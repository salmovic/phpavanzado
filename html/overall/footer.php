<footer class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-parallax-background" id="footer1-4" style="background-image: url(views/images/bg3.jpg);">
    ...
    <div class="mbr-section__container container">
        <div class="mbr-footer mbr-footer--wysiwyg row">
            <div class="col-sm-12">
                <p class="mbr-footer__copyright"><?php echo FOOTER_COPY; ?> <a class="mbr-footer__link text-gray" href="#/">Terminos de Uso</a>  | <a class="mbr-footer__link text-gray" href="#/">Política de Privacidad</a></p>
            </div>
        </div>
    </div>
</footer>
